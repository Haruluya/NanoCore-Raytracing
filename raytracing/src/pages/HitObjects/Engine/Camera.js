...
export default class Camera{
    ...
    constructor(canvasData,cameraData){
    ...
    shootRay(pixelX, pixelY) {
        ...
        let ndcX = (2 * pixelX) / this.canvasData.width - 1;
        const ndcY = 1 - (2 * pixelY) / this.canvasData.height;

        // Adjust ndcX based on aspect ratio
        const aspectRatio = this.canvasData.width / this.canvasData.height;
