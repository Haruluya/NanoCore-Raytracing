...
["_getCanvasColorData","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'vec3.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('vec3.wasm', import.meta.url).href;
}
...
/** @type {function(...*):?} */
var _getCanvasColorData = Module["_getCanvasColorData"] = createExportWrapper("getCanvasColorData");
/** @type {function(...*):?} */
