...
export default defineComponent({
    ...
    setup() {
        ...
        const Render = () => {
            ...
            //world.
            world.clear();
            world.add(new Sphere(vec3Add(bgCircleCenter,vec3Sub([.5,.5,1],[.5,.5,1])),100))
            world.add(new Sphere(vec3Add(circleCenter,vec3Sub([.5,.5,1],[.5,.5,1])),radius))
